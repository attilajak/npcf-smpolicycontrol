...
class N3gaLocation(Model):
    ...
    """
    def __init__(self, n3gpp_tai: Tai=None, n3_iwf_id: str=None, ue_ipv4_addr: Ipv4Addr=None, ue_ipv6_addr: Ipv6Addr=None, port_number: Uinteger=None):  # noqa: E501
    ...
    @n3gpp_tai.setter
    def n3gpp_tai(self, n3gpp_tai: Tai):
    ...
    @property
    def ue_ipv4_addr(self) -> Ipv4Addr:
    ...
    @ue_ipv4_addr.setter
    def ue_ipv4_addr(self, ue_ipv4_addr: Ipv4Addr):
    ...
    @property
    def ue_ipv6_addr(self) -> Ipv6Addr:
    ...
    @ue_ipv6_addr.setter
    def ue_ipv6_addr(self, ue_ipv6_addr: Ipv6Addr):
