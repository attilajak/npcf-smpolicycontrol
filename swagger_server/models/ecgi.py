...
class Ecgi(Model):
    ...
    """
    def __init__(self, plmn_id: PlmnId=None, eutra_cell_id: EutraCellId=None):  # noqa: E501
    ...
    @plmn_id.setter
    def plmn_id(self, plmn_id: PlmnId):
    ...
    @property
    def eutra_cell_id(self) -> EutraCellId:
    ...
    def eutra_cell_id(self, eutra_cell_id: EutraCellId):
