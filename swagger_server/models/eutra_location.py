...
class EutraLocation(Model):
    ...
    """
    def __init__(self, tai: Tai=None, ecgi: Ecgi=None, age_of_location_information: int=None, ue_location_timestamp: datetime=None, geographical_information: str=None, geodetic_information: str=None, global_ngenb_id: GlobalRanNodeId=None):  # noqa: E501
    ...
    @property
    def global_ngenb_id(self) -> GlobalRanNodeId:
    ...
    def global_ngenb_id(self, global_ngenb_id: GlobalRanNodeId):
